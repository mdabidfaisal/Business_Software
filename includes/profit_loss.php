...
<body>
    ...
    <div class="main main-bg">
        ...
        <div class="container-fluid">
            <p class="text-center font-monospace fs-3 fw-bolder text-light">Profit/Loss</p>
        </div>
        <div class="container-fluid">
        ...
        <div class="container bg-white">
            <p class="text-center font-monospace fs-5 fw-bolder text-black">Cost:0&#2547;</p>
            <p class="text-center font-monospace fs-5 fw-bolder text-black">Comission:0.00&#2547;</p>
            <p class="text-center font-monospace fs-5 fw-bolder text-black">Total Profit:0&#2547;</p>
            <p class="text-center font-monospace fs-5 fw-bolder text-black">Net Profit:0&#2547;</p>
        </div>
    </div>
