...
<div class="wrapper">
    <aside id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <!-- Category Start -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#cate"
            ...
            <!-- Subcategory Start -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#subc"
                    aria-expanded="false" aria-controls="subc">
                    <i class="lni lni-list"></i>
            ...
            <!-- Unit Menu Start -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#unit"
                ...
                <ul id="unit" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    <li class="sidebar-item">
                        <a href="../includes/unit_converter.php" class="sidebar-link">Add New</a>
                    </li>
                    <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                ...
                <ul id="supplier" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item">
                        <a href="../includes/supplier_all_trans.php" class="sidebar-link">All Transaction</a>
                    </li>
                </ul>
            </li>
            <!-- Supplier End -->
            ...
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#pr"
                    aria-expanded="false" aria-controls="pr">
            ...
            <!-- Sale Start -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#sale"
            ...
            <!-- Cost Start -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#Cost"
                    aria-expanded="false" aria-controls="Cost">
            ...
            <!-- Due Menu Start -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#Due"
                    aria-expanded="false" aria-controls="Due">
            ...
            <!-- Bank Menu -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#Bank"
            ...
            <!-- Loan Start -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#Loan"
            ...
            <!-- HR Menu -->
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#HR"
