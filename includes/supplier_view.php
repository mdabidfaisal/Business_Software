...
<body>
    ...
    <div class="main main-bg">
        ...
        <div class="container-fluid">
            <p class="text-center font-monospace fs-3 fw-bolder text-light">All Supplier</p>
        </div>
        <div class="container-fluid mt-5">
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <form action="">
                        <label for="paid2"
                            class="col-sm-6 col-form-label  text-light fs-5 fw-semibold font-monospace">Supplier</label>
                        <select class="form-select col-sm-6 text-center font-monospace fw-bold text-primary" id="unit">
                            <option value="unit1" class="text-center font-monospace fw-bold">Select</option>
