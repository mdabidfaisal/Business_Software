    ...
    <div class="main main-bg">
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-md-3 g-4 p-3 justify-content-center">
                <div class="col-md-4">
                    <p class="form-label fs-2 fw-bolder font-monospace text-light text-center">ADD CUSTOMER</p>
                    <form action="">
                        ...
                        <select class="form-select col-sm-6 text-center font-monospace fw-bold text-primary" id="paid">
                            <option value="cash" class="text-center font-monospace fw-bold">Retailer</option>
                            <option value="bKash" class="text-center font-monospace fw-bold">Wholesaler</option>
                        </select>
                        <label for="exampleDataList"
                            class="form-label fs-6 fw-bolder font-monospace text-light">Customer
                            Name</label>
