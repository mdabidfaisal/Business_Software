            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 p-3 justify-content-center">
                <div class="col-md-4">
                    ...
                    <form action="backend.php" method="post">
                        ...
                        <input class="form-control" list="datalistOptions" id="exampleDataList" name="unitName"
                            placeholder="Type to search..." required>
                        <input class="form-control" list="datalistOptions" id="exampleDataList" name="unitLabel"
                            placeholder="Example: Ton/Kg" required>
                        <input class="form-control" list="datalistOptions" id="exampleDataList" name="relation"
                            placeholder="Example: 1/1000" required>
                        <input class="form-control" list="datalistOptions" id="exampleDataList" name="description"
